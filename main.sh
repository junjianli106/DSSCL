...
python main_w_he.py --weight_orig 0.3 --num-cluster '40' --resume '/homec/xxxxx/python_projects/Pathological_Image_Classification/SSCL/experiment_w_he/checkpoint_0020.pth.tar'
